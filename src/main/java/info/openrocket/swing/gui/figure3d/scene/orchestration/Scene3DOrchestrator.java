 ...
 * <h3>Usage Example:</h3>
 * <pre>
 * Scene3DOrchestrator orchestrator = new Scene3DOrchestrator(rocket, 800, 600, 1600, 1200);
...
public class Scene3DOrchestrator {
    ...
    private final RealisticRenderer renderer;
	...
	public static class Builder {
		...
		public Scene3DOrchestrator build() throws Exception {
			...
			Scene3DOrchestrator orchestrator = new Scene3DOrchestrator(rocket, viewport, camera, scene, config);
	 ...
	 */
	private Scene3DOrchestrator(Rocket rocket, ViewportDimensions viewport, Camera camera, SceneView scene, RenderingConfiguration config) throws Exception {

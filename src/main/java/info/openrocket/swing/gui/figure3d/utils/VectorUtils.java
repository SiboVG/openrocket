...
public abstract class VectorUtils {
	 ...
	 */
	public static Vector3f coordinateToVector3f(Coordinate coordinate) {
		return new Vector3f((float) coordinate.x, (float) coordinate.y, (float) coordinate.z);
	}
	 ...
	 */
	public static Vector4f coordinateToVector4f(Coordinate coordinate) {
		return new Vector4f((float) coordinate.x, (float) coordinate.y, (float) coordinate.z, (float) coordinate.weight);
	}
}

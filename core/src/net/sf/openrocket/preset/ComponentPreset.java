...
public class ComponentPreset implements Comparable<ComponentPreset>, Serializable {
	...
	public final static TypedKey<Manufacturer> MANUFACTURER = new TypedKey<>("Manufacturer", Manufacturer.class);
	...
	public final static TypedKey<Double> INNER_DIAMETER = new TypedKey<>("InnerDiameter", Double.class, UnitGroup.UNITS_LENGTH);
	public final static TypedKey<Double> OUTER_DIAMETER = new TypedKey<>("OuterDiameter", Double.class, UnitGroup.UNITS_LENGTH);
	public final static TypedKey<Double> FORE_SHOULDER_LENGTH = new TypedKey<>("ForeShoulderLength", Double.class, UnitGroup.UNITS_LENGTH);
	public final static TypedKey<Double> FORE_SHOULDER_DIAMETER = new TypedKey<>("ForeShoulderDiameter", Double.class, UnitGroup.UNITS_LENGTH);
	public final static TypedKey<Double> FORE_OUTER_DIAMETER = new TypedKey<>("ForeOuterDiameter", Double.class, UnitGroup.UNITS_LENGTH);
	public final static TypedKey<Double> AFT_SHOULDER_LENGTH = new TypedKey<>("AftShoulderLength", Double.class, UnitGroup.UNITS_LENGTH);
	public final static TypedKey<Double> AFT_SHOULDER_DIAMETER = new TypedKey<>("AftShoulderDiameter", Double.class, UnitGroup.UNITS_LENGTH);
	public final static TypedKey<Double> AFT_OUTER_DIAMETER = new TypedKey<>("AftOuterDiameter", Double.class, UnitGroup.UNITS_LENGTH);
	public static final TypedKey<Double> CD = new TypedKey<>("DragCoefficient", Double.class, UnitGroup.UNITS_COEFFICIENT);
	...
	public final static TypedKey<Double> THICKNESS = new TypedKey<>("Thickness", Double.class, UnitGroup.UNITS_LENGTH);
	...
	public final static TypedKey<Double> DIAMETER = new TypedKey<>("Diameter", Double.class, UnitGroup.UNITS_LENGTH);
	public final static TypedKey<byte[]> IMAGE = new TypedKey<>("Image", byte[].class);

	//  RAIL BUTTON SPECIFIC
	public final static TypedKey<Double> BASE_HEIGHT = new TypedKey<>("BaseHeight", Double.class, UnitGroup.UNITS_LENGTH);
	public final static TypedKey<Double> FLANGE_HEIGHT = new TypedKey<>("FlangeHeight", Double.class, UnitGroup.UNITS_LENGTH);
	public final static TypedKey<Double> SCREW_HEIGHT = new TypedKey<>("ScrewHeight", Double.class, UnitGroup.UNITS_LENGTH);
	public final static TypedKey<Double> SCREW_MASS = new TypedKey<>("ScrewMass", Double.class, UnitGroup.UNITS_MASS);
	...
	public final static TypedKey<Double> SPILL_DIA = new TypedKey<>("SpillDia", Double.class, UnitGroup.UNITS_LENGTH);
	public final static TypedKey<Double> SURFACE_AREA = new TypedKey<>("SurfaceArea", Double.class, UnitGroup.UNITS_LENGTH);
	...
	public final static TypedKey<Double> LINE_LENGTH = new TypedKey<>("LineLength", Double.class, UnitGroup.UNITS_LENGTH);
	public final static TypedKey<Material> LINE_MATERIAL = new TypedKey<>("LineMaterial", Material.class);
	public final static TypedKey<Double> PACKED_LENGTH = new TypedKey<>("PackedLength", Double.class, UnitGroup.UNITS_LENGTH);

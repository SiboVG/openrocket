...
public interface DecalImage extends ChangeSource, Comparable<DecalImage> {
	 ...
	 * @throws IOException
	 */
    InputStream getBytes() throws FileNotFoundException, IOException, DecalNotFoundException;
	 ...
	 * @throws IOException
	 */
    void exportImage(File file) throws IOException, DecalNotFoundException;

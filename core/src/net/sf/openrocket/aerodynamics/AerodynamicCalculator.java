...
public interface AerodynamicCalculator extends Monitorable {
	 ...
	 */
	Coordinate getWorstCP(FlightConfiguration configuration, FlightConditions conditions,
			WarningSet warnings);
	 ...
	 */
	void checkGeometry(FlightConfiguration configuration, final RocketComponent component, WarningSet warnings);
}

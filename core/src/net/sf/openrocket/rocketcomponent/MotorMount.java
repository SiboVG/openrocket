...
public interface MotorMount extends ChangeSource, FlightConfigurableComponent {
     ...
     */
    void setMotorMount(boolean acting);
	 ...
	 */
    Iterator<MotorConfiguration> getMotorIterator();
	 ...
	 *         this motor mount.
	 */
    MotorConfigurationSet getMotorConfigurationSet();
	 ...
	 */
    void setMotorConfig( final MotorConfiguration newMotorConfig, final FlightConfigurationId fcid);
	 ...
	 */
    void setMotorOverhang(double overhang);

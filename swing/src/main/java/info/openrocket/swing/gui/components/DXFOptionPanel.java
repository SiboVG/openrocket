...
public class DXFOptionPanel extends JPanel {
	...
	public DXFOptionPanel() {
		this(false);
	}

	public DXFOptionPanel(boolean showCrosshairToggle) {
		super(new MigLayout());
		this.showCrosshairToggle = showCrosshairToggle;
		
		// Load part spacing and crosshair size from preferences (reuse SVG preferences)
	...
	/**
	 * Store the current settings to user preferences (reuse SVG preferences).
	 */
